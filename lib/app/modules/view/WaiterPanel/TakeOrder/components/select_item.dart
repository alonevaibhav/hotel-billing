...
//     // final currentOrderStatus = tableInfo?.currentOrder ?? 0;
...
//
//     // controller.fetchOrder(orderId, tableId);
//
//     print('Fetching order for Table ID: $tableId, Order ID: $orderId');
//
//     // Null check for current order
//     final currentOrderStatus = tableInfo?.currentOrder;
//
//     if (currentOrderStatus == null) {
//       developer.log(
//           '❌ currentOrder is NULL for tableId = $tableId',
//           name: 'ORDER_CHECK'
//       );
//       controller.fetchOrder(orderId, tableId);
//
...
//     } else {
//       developer.log(
//           '✅ currentOrder is NOT null for tableId = $tableId',
//           name: 'ORDER_CHECK'
//       );
//
//     }
