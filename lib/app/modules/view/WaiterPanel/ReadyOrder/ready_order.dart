...
//                     isEmpty: (controller) => controller.groupedOrders.isEmpty,
//                     onRefresh: () => controller.refreshOrders(),
//                     loadingText: 'Loading ready orders...',
//                     emptyStateText: 'No orders ready to serve',
//                     errorTitle: 'Failed to load orders',
//                     observeData: [
//                       controller.groupedOrders,
//                       controller.readyItems,
//                       controller.servingOrderIds,
//                       controller.expandedOrders,
//                       controller.isSocketConnected,
//                     ],
//                     builder: (controller) => buildOrdersList(controller, scaleFactor),
//                   ),
//                 ),
//               ],
//             ),
...
//         return buildOrderCard(context, controller, groupedOrder, index, scaleFactor);
//       },
//     ));
//   }
//
...
//                   Row(
//                     children: [
//                       buildInfoChip('Table ${groupedOrder.tableNumber}', Icons.chair,
//                           scaleFactor),
//                     ],
//                   ),
//                 ],
...
//                   Obx(() {
//                     final isExpanded =
//                     controller.expandedOrders.contains(groupedOrder.orderId);
//                     final itemsToShow =
...
//                           Gap((4 * scaleFactor).h),
//                           GestureDetector(
//                             onTap: () => controller.toggleOrderExpansion(groupedOrder.orderId),
//                             child: Container(
//                               padding: EdgeInsets.symmetric(
...
//                           color: isServing ? Colors.orange[600] : Colors.green[600],
//                         ),
//                       ),
//                     ],
//                   ),
...
//     final isVegetarian = true; // You can add this field to ReadyOrderItem model if needed
//
//     return Padding(
              ...
              child: RefreshIndicator(
                ...
                child: Obx(() {
                  ...
                  if (controller.errorMessage.value.isNotEmpty) {
                    return Center(
                      child: SingleChildScrollView( // Ensures retry button is accessible on small screens
                  ...
                  if (controller.groupedOrders.isEmpty) {
                    return Center(
                      child: SingleChildScrollView( // Ensures pull-to-refresh works even in empty state
                        physics: const AlwaysScrollableScrollPhysics(),
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
