...
//                     isEmpty: (controller) => controller.ordersData.isEmpty,
...
//     // AsyncStateBuilder already handles empty state, so just return the list
...
//         return buildOrderCard(context, controller, orderDetail, index, scaleFactor);
//       },
//     );
//   }
//
...
//     final isVegetarian = true; // You can add this field to OrderItem model if needed
//
//     return Padding(
