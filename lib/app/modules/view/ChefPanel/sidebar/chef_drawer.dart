...
class ChefDrawerWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Use Get.find() to get existing instance instead of creating new one
    final ChefDrawerController controller = Get.find<ChefDrawerController>();
      ...
      child: SafeArea(
        child: Column(
          children: [
            ...
            // Menu Items - Wrapped in Obx for reactivity
            Expanded(
              child: Obx(() => ListView(
                padding: const EdgeInsets.symmetric(horizontal: 12),
                children: [
