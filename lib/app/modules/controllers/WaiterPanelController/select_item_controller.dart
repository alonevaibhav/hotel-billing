...
//         final state = getTableState(tableId);
//
//         // NEW: allow fresh GET next time user opens this table
//         state.hasLoadedOrder.value = false;
//
//         // OPTIONAL: also update placedOrderId just to be safe
//         state.placedOrderId.value = placedOrderId;
//
//         // Freeze the newly added items
//         freezeItems(state, state.orderItems);
//
//         final tableNumber = tableInfo?.table.tableNumber ?? tableId.toString();
//
...
//
//           // Now freeze items
//           freezeItems(state, orderItems);
//
//           final tableNumber =
//               tableInfo?.table.tableNumber ?? tableId.toString();
//
//           SnackBarUtil.showSuccess(
//             context,
