...
//                   "id": 2,
//                   "hotel_owner_id": 1,
//                   "item_name": "Updated Chicken Tikka",
//                   "description": "Updated description",
//                   "category": null,
//                   "menu_category_id": 1,
//                   "image_url": "https://example.com/updated-chicken-tikka.jpg",
//                   "price": "319.99",
//                   "preparation_time": 18,
//                   "is_active": 1,
//                   "is_featured": null,
...
//
//     developer.log('Processed ${itemsList.length} items in ${categories.length} categories');
//   }
//
//   void _filterItems() {
...
//       developer.log('Incremented ${item['item_name']} to ${allItems[index]['quantity']}');
//     }
//   }
//
...
//         _updateSelectedItems();
//         _filterItems(); // Refresh filtered list
//         developer.log('Decremented ${item['item_name']} to ${allItems[index]['quantity']}');
//       }
//     }
//   }
//
//   void _updateSelectedItems() {
//     selectedItems.value = allItems.where((item) => (item['quantity'] as int) > 0).toList();
//   }
//
...
//           };
//
//           orderController.addItemToTable(tableId, orderItem, context, currentTable.value);
//         }
//       }
//
...
//     return selectedItems.fold<int>(0, (sum, item) => sum + (item['quantity'] as int));
//   }
//
...
class AddItemsController extends GetxController {
  ...
  void _processMenuData() {
    ...
    itemsList.sort((a, b) => (a['item_name'] as String).compareTo(b['item_name'] as String));
  ...
  void _filterItems() {
    ...
    filtered.sort((a, b) => (a['item_name'] as String).compareTo(b['item_name'] as String));

    filteredItems.value = filtered;

    developer.log('Filtered items: ${filtered.length} out of ${allItems.length}');
  }
